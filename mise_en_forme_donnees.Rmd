...
```{r tableau-1}
table(t.del$annee, t.del$classe)
tab1 <- table(t.del$annee, t.del$classe)
```
...
```{r mosaicplot}
mosaicplot(tab2, shade = T, las = 2, main = "titre", xlab= "?x", ylab="y")
```
...
```{r tapply}
tapply(t.del$annee, t.del$classe, summary, na.rm=TRUE)
