...
```{r essai}
# en repassant la table en format wide ??
# df_O_wide <- spread(data = t.del.O, key='id', value='info commune')
# t.del.O['indicEPCI'] = 1
...
df_O_groupby_test <- mutate(df_O_groupby, liste_commune=sum(EPCI))
# ok : dans liste_commune : somme des 3 zonages EPCI si les 3 communes sont renseignées, NA si une commune manquante
