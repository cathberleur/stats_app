...
# très long, pas sûre que ça marche...
#Error in t.del.A$dept_serv : $ operator is invalid for atomic vectors : je sais pas pouquoi ça marchepas... (clem)
```

```{r essai}
d.del.A
df_A_long <- melt(data = t.del.A, id.vars=c('insee',"nom","wikipedia","surf_ha","id","annee","duree_debut_fait_date_enregistrement","classe","dept_serv"),variable.ame=)
```
