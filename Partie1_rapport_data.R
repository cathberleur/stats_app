...
data_tableau1 <- del2016_2021_dt10[ , .(classe2,cog_com_22_inf,cog_com_22_vict,cog_com_22_mec,compteur)]
...
tableau1 <- subset(tableau1, select=c(classe2, Nb_atteintes,IVM,IV,IM,VM,I,V,M,Neant))
